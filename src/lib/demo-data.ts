...
export const auditEvents: AuditEvent[] = [
  { id: 601, action_key: "risk.treatment.approve", action_label: "PATCH /api/v1/risks/treatments/3/approve", category: "risks", status: "completed", summary: "Approved treatment: TLS baseline remediation", details: { path: "/api/v1/risks/treatments/3/approve", method: "PATCH", actor_user_id: 2, actor_email: "ada@phantix.site", token_type: "app_session", passive: false }, source: "api_middleware", ip_address: "102.89.34.12", initiator_name: "Ada Okonkwo", initiator_title: "IT Admin", authorizer_name: "Chidi Eze", authorizer_title: "CISO", created_at: "2026-07-20T08:05:00Z" },
  { id: 600, action_key: "vapt.campaign.start", action_label: "POST /api/v1/vapt/campaigns/13/start", category: "vapt", status: "completed", summary: "Started campaign: Q3 External Assessment", details: { path: "/api/v1/vapt/campaigns/13/start", method: "POST", actor_user_id: 2, actor_email: "ada@phantix.site", token_type: "app_session", passive: false }, source: "api_middleware", ip_address: "102.89.34.12", initiator_name: "Ada Okonkwo", initiator_title: "IT Admin", authorizer_name: "Chidi Eze", authorizer_title: "CISO", created_at: "2026-07-14T10:30:00Z" },
  { id: 599, action_key: "data.access", action_label: "GET /api/v1/assets/intelligence/dashboard", category: "data_access", status: "completed", summary: "GET /api/v1/assets/intelligence/dashboard", details: { path: "/api/v1/assets/intelligence/dashboard", method: "GET", actor_user_id: 2, actor_email: "ada@phantix.site", token_type: "app_session", passive: true }, source: "api_middleware", ip_address: "102.89.34.12", initiator_name: "Ada Okonkwo", initiator_title: "IT Admin", authorizer_name: "Phantix Test Org", authorizer_title: "org_admin", created_at: "2026-07-13T15:22:00Z" },
  { id: 598, action_key: "data.access", action_label: "GET /api/v1/scans/results", category: "data_access", status: "completed", summary: "GET /api/v1/scans/results", details: { path: "/api/v1/scans/results", method: "GET", actor_user_id: 2, actor_email: "ada@phantix.site", token_type: "app_session", passive: true }, source: "api_middleware", ip_address: "102.89.34.12", initiator_name: "Ada Okonkwo", initiator_title: "IT Admin", authorizer_name: "Phantix Test Org", authorizer_title: "org_admin", created_at: "2026-07-13T15:20:00Z" },
