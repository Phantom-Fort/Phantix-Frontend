...
Security posture data (assets, findings, risks, etc.) is intended for your **dedicated security database**. Platform data covers login, billing, and control-plane concerns. See [06-privacy-and-trust.md](./06-privacy-and-trust.md).

### Do you store our source code?

Repository analysis uses **ephemeral** workspaces that are destroyed after the job. AI and reports receive **findings**, not permanent copies of your repositories.

### Can Free analyze private GitHub repos?

**No.** Free may analyze **public** repos via the GitHub App. Private repos require Premium. Enforced in the product API.

### Will AI invent vulnerabilities?

No by design. AI agents must use engine evidence. Reports emphasize **verified** findings. Hallucination and human-review controls exist on the AI path.
...
Use **engagements**: human-led VAPT on top of the platform, with reports still flowing through verification and impact.
