...
export const assets: Asset[] = [
  ...
  { id: 121, asset_type: "web_path", value: "portal.acme.ng/robots.txt", name: "robots.txt", source: "robots_txt", is_verified: true, verification_method: "inherited", criticality: "low", environment: "production", tags: [], first_discovered_at: "2026-07-20T09:00:00Z", last_seen_at: "2026-07-21T04:58:00Z" },
  { id: 122, asset_type: "web_path", value: "portal.acme.ng/admin", name: "Admin area", source: "robots_txt", is_verified: true, verification_method: "inherited", criticality: "high", environment: "production", tags: [], first_discovered_at: "2026-07-20T09:00:00Z", last_seen_at: "2026-07-21T04:58:00Z" },
  { id: 123, asset_type: "web_path", value: "portal.acme.ng/admin/login", name: "Admin login", source: "directory_enum", is_verified: true, verification_method: "inherited", criticality: "high", environment: "production", tags: [], first_discovered_at: "2026-07-20T09:05:00Z", last_seen_at: "2026-07-21T04:58:00Z" },
  { id: 124, asset_type: "web_path", value: "api.acme.ng/v2", name: "API v2", source: "chain", is_verified: true, verification_method: "inherited", criticality: "low", environment: "production", tags: [], first_discovered_at: "2026-07-20T09:10:00Z", last_seen_at: "2026-07-21T05:00:00Z" },
  { id: 125, asset_type: "web_path", value: "api.acme.ng/v2/payments", name: "Payments endpoint", source: "openapi", is_verified: true, verification_method: "inherited", criticality: "critical", environment: "production", tags: [], first_discovered_at: "2026-07-20T09:10:00Z", last_seen_at: "2026-07-21T05:00:00Z" },
...
export const auditEvents: AuditEvent[] = ([
  ...
  { id: 598, action_key: "data.access", action_label: "View scan results", category: "data_access", status: "completed", summary: "Viewed scan findings and results", details: { path: "/api/v1/scans/results", method: "GET", actor_user_id: 2, actor_email: "ada@phantixlabs.com", token_type: "app_session", passive: true }, source: "api_middleware", ip_address: "102.89.34.12", initiator_name: "Ada Okonkwo", initiator_title: "IT Admin", authorizer_name: "SecureGraph Test Org", authorizer_title: "org_admin", created_at: "2026-07-13T15:20:00Z" },
  { id: 597, action_key: "compliance.assessment.run", action_label: "Run compliance assessment", category: "compliance", status: "completed", summary: "Ran ISO 27001 assessment", details: { path: "/api/v1/compliance/assessments/2/run", method: "POST", actor_user_id: 2, actor_email: "ada@phantixlabs.com", token_type: "app_session", passive: false }, source: "api_middleware", ip_address: "102.89.34.12", initiator_name: "Ada Okonkwo", initiator_title: "IT Admin", authorizer_name: "Chidi Eze", authorizer_title: "CISO", created_at: "2026-07-12T11:00:00Z" },
