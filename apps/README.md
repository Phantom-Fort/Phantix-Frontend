...
| Blog | `securegraph-blog` | `blog.phantixlabs.com` | 5178 |
...
The landing page links to it from the top nav, the mobile menu and the footer
(`The Weekly`, via `BLOG_URL` in `landing/src/lib/config.ts`) — keep that host
in step with this app's Vercel project.
