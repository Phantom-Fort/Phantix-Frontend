...
export const howToDocs: Entry[] = [
  ...
  e("howto-platform-index", "Platform — how-to index", "Org admin tasks on platform.phantix.site.", "how-to-platform", platIndex),
  ...
  e("howto-app-index", "Command Centre — how-to index", "Operator tasks on app.phantix.site.", "how-to-app", appIndex),
