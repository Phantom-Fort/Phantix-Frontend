...
> **API access: AI Agent plan.** Full cybersecurity platform: use Phantix in the product UI under Free, Starter or Growth.
...
| Growth is continuous | Cancel/expire paths are defined (reminders + short grace may apply) |
| Private GitHub needs a paid plan | Enforced in product, not only on the website |
